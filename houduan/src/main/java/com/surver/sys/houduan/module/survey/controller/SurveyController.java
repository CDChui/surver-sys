...
import com.surver.sys.houduan.module.survey.service.SurveyService;
...
public class SurveyController {
    ...
    public ResponseEntity<byte[]> exportSurvey(@PathVariable Long id) {
        ...
        headers.setContentDisposition(ContentDisposition.attachment()
                .filename("survey-" + id + ".xlsx", StandardCharsets.UTF_8)
                .build());
    ...
    public ApiResponse<?> getPublicSurvey(@PathVariable Long id) {
        UserPrincipal principal = SecurityUtils.getCurrentUser();
        return ApiResponse.success(surveyService.getPublicSurvey(principal, id));
    }
